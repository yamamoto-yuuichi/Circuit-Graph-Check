...
<iframe src="自己保持回路_正常.pdf" width="100%" height="600px"></iframe>
...
<!-- 画像挿入位置：作成手順の対象となる回路図 -->
![作成手順で例に使う自己保持回路](画像ファイル名をここに記入.png)
...
<!-- 画像挿入位置：正常な回路の実行結果（グラフ表示） -->
![正常な回路の実行結果](画像ファイル名をここに記入.png)
...
<!-- 画像挿入位置：停止ボタンを削除した回路の実行結果（グラフ表示） -->
![停止ボタンを削除した回路の実行結果](画像ファイル名をここに記入.png)
...
<!-- 画像挿入位置：自己保持接点を削除した回路の実行結果（グラフ表示） -->
![自己保持接点を削除した回路の実行結果](画像ファイル名をここに記入.png)
